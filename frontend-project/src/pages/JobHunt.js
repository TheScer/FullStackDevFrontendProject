...
export const JobHunt = () => {
  ...
  return (
    <div>
      <h2>Job Hunt!</h2>
      <h3>
        Are you tired of your current 9 to 5, and looking to make a change? Or
        at the very Least see whats out there? This page caters directly to you,
        bringing all the job posting news there can be to see what kinf of
        proffession you would like to Pivot to Next!
      </h3>
